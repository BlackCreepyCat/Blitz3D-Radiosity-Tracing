...
;e1.entity=add_cube(0,0,20, 9,10,9, 15,15,15 , 1)
;
;e1.entity=add_sphere(0, 8,20, 0.4, 500,500,500 )
;
;e1.entity=add_cube(-9,0,20, 0.05,10,9, 20,0,0 , 0)
;e1.entity=add_cube( 9,0,20, 0.05,10,9, 0,20,5 , 0)
